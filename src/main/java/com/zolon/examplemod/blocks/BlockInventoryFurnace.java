...
import com.zolon.examplemod.util.handler.GuiHandlerFurnaceExample;
...
public class BlockInventoryFurnace extends BlockContainer{
	...
	public BlockInventoryFurnace(String name)
	{
		super(Material.ROCK);
		...
		GameRegistry.registerTileEntity(TileInventoryFurnace.class, "modexample_inventory_furnace");
		NetworkRegistry.INSTANCE.registerGuiHandler(ExampleMod.instance, GuiHandlerRegistry.getInstance());
		GuiHandlerRegistry.getInstance().registerGuiHandler(new GuiHandlerFurnaceExample(), GuiHandlerFurnaceExample.getGuiID());
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand,
		...
		playerIn.openGui(ExampleMod.instance, GuiHandlerFurnaceExample.getGuiID(), worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
